...
CATEGORY_KEYWORDS = {
    "R&D": ["r&d", "연구개발", "기술개발", "연구과제", "기술혁신", "연구사업", "기술실증",
            "실증사업", "기술지원", "시제품", "특허", "지식재산", "ip ", "연구인력"],
    "사업화": ["사업화", "성장지원", "판로", "마케팅", "수출", "내수", "경영", "혁신바우처",
             "스케일업", "바우처", "사업전환", "제품화", "상용화", "시장진출", "혁신제품",
             "구매조건부", "공공구매", "납품", "유통"],
    "투자연계": ["투자", "펀드", "금융", "융자", "보증", "대출", "자금지원",
              "정책자금", "크라우드펀딩", "엔젤", "벤처캐피탈", "vc"],
    "입주지원": ["입주", "입주기업", "보육센터", "창업보육", "오피스", "시설입주",
              "지식산업센터", "창업공간", "공유오피스", "창업센터"],
    "IR피칭": ["ir ", "피칭", "데모데이", "투자유치", "ir피칭", "사업설명회",
             "비즈니스미팅", "네트워킹", "밋업"],
    "경진대회": ["경진", "공모전", "대회", "어워드", "contest", "경연", "챌린지", "해커톤",
              "아이디어공모", "창업경진"],
    "교육멘토링": ["교육", "멘토", "컨설팅", "세미나", "아카데미", "워크숍", "특강", "강좌",
                "역량강화", "전문가자문", "코칭", "캠프", "부트캠프", "인큐베이팅"],
    "인력지원": ["인력", "채용", "인턴", "고용", "일자리", "파견", "연구인력지원사업",
              "전문인력", "청년고용", "재직자"],
    "창업지원": ["창업", "예비창업", "초기창업", "창업패키지", "스타트업", "창업지원",
              "재도전", "재창업", "청년창업"],
}
